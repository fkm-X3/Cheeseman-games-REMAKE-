...
export default function LeaderboardPage() {
  ...
  const [selectedGame, setSelectedGame] = useState("cheese-clicker");
      ...
      <section className="card" style={{ gridColumn: "1 / -1" }}>
        ...
        <div>
          <button
            ...
            onMouseEnter={(e) => {
              e.target.style.backgroundColor = "rgba(83, 114, 255, 0.4)";
          ...
          {!leaderboard.length ? (
            ...
            leaderboard.map((entry, index) => (
              <li
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = "rgba(83, 114, 255, 0.1)";
                }}
                onMouseLeave={(e) => {
